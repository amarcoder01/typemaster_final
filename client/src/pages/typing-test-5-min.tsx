      ...
      <div className="container mx-auto px-4 pt-20 pb-16">
        ...
        <section className="max-w-4xl mx-auto text-center pt-8 sm:pt-12 md:pt-16 pb-8 sm:pb-12 md:pb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-8 sm:mb-12">
            <Link href="/">
              <Button size="lg" className="bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white text-sm sm:text-base md:text-lg px-4 sm:px-6 md:px-8 py-3 sm:py-4 md:py-6 w-full sm:w-auto" data-testid="button-start-5min-test">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            <Card className="bg-slate-800/50 border-slate-700">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-white text-base sm:text-lg">Maximum Accuracy</CardTitle>
              </CardHeader>
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-white text-base sm:text-lg">Stamina Training</CardTitle>
              </CardHeader>
              <CardContent className="p-4 sm:p-6 pt-0">
                <p className="text-sm sm:text-base text-slate-400">
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-white text-base sm:text-lg">Job Assessment Ready</CardTitle>
              </CardHeader>
              <CardContent className="p-4 sm:p-6 pt-0">
                <p className="text-sm sm:text-base text-slate-400">
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-white text-base sm:text-lg">Deep Analytics</CardTitle>
              </CardHeader>
              <CardContent className="p-4 sm:p-6 pt-0">
                <p className="text-sm sm:text-base text-slate-400">
        ...
        <section className="max-w-4xl mx-auto py-8 sm:py-12 md:py-16">
          <article className="prose prose-invert prose-cyan prose-sm sm:prose-base md:prose-lg max-w-none">
            ...
            <div className="bg-slate-800/80 border border-purple-500/30 rounded-xl p-4 sm:p-6 mb-6 sm:mb-8 shadow-lg shadow-purple-900/10" data-testid="ai-answer-section">
              <div className="flex items-center gap-2 mb-3 sm:mb-4">
                <Brain className="w-5 h-5 sm:w-6 sm:h-6 text-purple-400" />
                <h2 className="text-base sm:text-lg md:text-xl font-bold text-white m-0 !mt-0">Quick Answer: 5 Minute Typing Test</h2>
              </div>
              <p className="text-slate-300 text-sm sm:text-base md:text-lg leading-relaxed mb-3 sm:mb-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 not-prose">
                <div>
                  <h3 className="font-semibold text-purple-400 mb-1 text-sm sm:text-base">Key Benefit</h3>
                  <p className="text-xs sm:text-sm text-slate-400">Most accurate predictor of <strong>real-world job performance</strong> and typing stamina.</p>
                </div>
                <div>
                  <h3 className="font-semibold text-purple-400 mb-1 text-sm sm:text-base">Pro Tip</h3>
                  <p className="text-xs sm:text-sm text-slate-400">Pace yourself at <strong>90% of your max speed</strong> to avoid burnout and error spikes in minutes 3-5.</p>
                </div>
              </div>
            </div>

            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white">What is a 5 Minute Typing Test?</h2>
            ...
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mt-6 sm:mt-8">Professional Typing Standards (5-Minute Test)</h3>
            ...
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mt-6 sm:mt-8">Why 5 Minutes is the Professional Standard</h3>
            <p className="text-sm sm:text-base md:text-lg text-slate-300 leading-relaxed">
            ...
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mt-6 sm:mt-8">Training Strategy for 5-Minute Tests</h3>
            ...
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mt-6 sm:mt-8">Common Challenges in 5-Minute Tests</h3>
            <div className="space-y-3 sm:space-y-4">
              <div className="bg-slate-800/50 border-l-4 border-yellow-500 p-3 sm:p-4">
                <h4 className="text-base sm:text-lg font-bold text-yellow-400 mb-1.5 sm:mb-2">Speed Decline</h4>
              ...
              <div className="bg-slate-800/50 border-l-4 border-yellow-500 p-3 sm:p-4">
                <h4 className="text-base sm:text-lg font-bold text-yellow-400 mb-1.5 sm:mb-2">Accuracy Drop</h4>
                <p className="text-sm sm:text-base text-slate-300">
              ...
              <div className="bg-slate-800/50 border-l-4 border-yellow-500 p-3 sm:p-4">
                <h4 className="text-base sm:text-lg font-bold text-yellow-400 mb-1.5 sm:mb-2">Mental Fatigue</h4>
                <p className="text-sm sm:text-base text-slate-300">
            ...
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mt-6 sm:mt-8">How Employers Use 5-Minute Tests</h3>
            <p className="text-sm sm:text-base md:text-lg text-slate-300 leading-relaxed">
            ...
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mt-6 sm:mt-8">Advanced Features for 5-Minute Tests</h3>
            <ul className="list-disc list-inside space-y-2 text-sm sm:text-base md:text-lg text-slate-300">
            ...
            <div className="bg-slate-800/50 border-l-4 border-cyan-500 p-4 sm:p-6 my-6 sm:my-8">
              <h4 className="text-base sm:text-lg md:text-xl font-bold text-cyan-400 mb-2">Pro Tip for Job Tests</h4>
              <p className="text-sm sm:text-base text-slate-300">
            ...
            <h4 className="text-base sm:text-lg md:text-xl font-semibold text-cyan-400 mt-4 sm:mt-6">Is 5 minutes too long for a typing test?</h4>
            ...
            <h4 className="text-base sm:text-lg md:text-xl font-semibold text-cyan-400 mt-4 sm:mt-6">What's a good score on a 5-minute typing test?</h4>
            <p className="text-sm sm:text-base md:text-lg text-slate-300">
            ...
            <h4 className="text-base sm:text-lg md:text-xl font-semibold text-cyan-400 mt-4 sm:mt-6">How can I prevent fatigue during 5-minute tests?</h4>
            <p className="text-sm sm:text-base md:text-lg text-slate-300">
            ...
            <div className="text-center mt-8 sm:mt-12">
              <Link href="/">
                <Button size="lg" className="bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white text-sm sm:text-base md:text-lg px-6 sm:px-8 md:px-12 py-3 sm:py-4 md:py-6 w-full sm:w-auto" data-testid="button-start-test-bottom">
                  <Timer className="mr-2 h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6" />
        ...
        {/* Related Tests */}
        <section className="max-w-6xl mx-auto py-8 sm:py-12 md:py-16">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-center text-white mb-8 sm:mb-12">Choose Your Test Duration</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            ...
            <Link href="/3-minute-typing-test">
              <Card className="bg-slate-800/50 border-slate-700 hover:border-cyan-500 transition-colors cursor-pointer" data-testid="card-3min-test">
                <CardHeader className="p-4 sm:p-6">
                  <CardTitle className="text-white text-base sm:text-lg">3 Minute Test</CardTitle>
                  <CardDescription className="text-slate-400 text-sm sm:text-base">

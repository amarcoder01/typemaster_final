      ...
      <div className="container mx-auto px-4 pt-20 pb-16">
        ...
        <section className="max-w-4xl mx-auto text-center pt-8 sm:pt-12 md:pt-16 pb-8 sm:pb-12 md:pb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-8 sm:mb-12">
            <Link href="/">
              <Button size="lg" className="bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white text-sm sm:text-base md:text-lg px-4 sm:px-6 md:px-8 py-3 sm:py-4 md:py-6 w-full sm:w-auto" data-testid="button-start-3min-test">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            <Card className="bg-slate-800/50 border-slate-700">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-white text-base sm:text-lg">Most Accurate</CardTitle>
              </CardHeader>
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-white text-base sm:text-lg">Consistent Results</CardTitle>
              </CardHeader>
              <CardContent className="p-4 sm:p-6 pt-0">
                <p className="text-sm sm:text-base text-slate-400">
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              <CardHeader className="p-4 sm:p-6">
                <Clock className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 text-cyan-400 mb-3 sm:mb-4" />
                <CardTitle className="text-white text-base sm:text-lg">Build Stamina</CardTitle>
              </CardHeader>
              <CardContent className="p-4 sm:p-6 pt-0">
                <p className="text-sm sm:text-base text-slate-400">
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-white text-base sm:text-lg">Professional Standard</CardTitle>
              </CardHeader>
              <CardContent className="p-4 sm:p-6 pt-0">
                <p className="text-sm sm:text-base text-slate-400">
        ...
        <section className="max-w-4xl mx-auto py-8 sm:py-12 md:py-16">
          <article className="prose prose-invert prose-cyan prose-sm sm:prose-base md:prose-lg max-w-none">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white">What is a 3 Minute Typing Test?</h2>
            ...
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mt-6 sm:mt-8">Professional Typing Speed Benchmarks</h3>
            ...
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mt-6 sm:mt-8">Why 3 Minutes is the Gold Standard</h3>
            <p className="text-sm sm:text-base md:text-lg text-slate-300 leading-relaxed">
            ...
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mt-6 sm:mt-8">How to Maximize Your 3 Minute Test Score</h3>
            <ol className="list-decimal list-inside space-y-2 sm:space-y-3 text-sm sm:text-base md:text-lg text-slate-300">
            ...
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mt-6 sm:mt-8">1 Minute vs 3 Minute vs 5 Minute Tests</h3>
            <div className="overflow-x-auto -mx-4 px-4 sm:mx-0 sm:px-0 my-4 sm:my-6">
              <table className="w-full min-w-full border-collapse bg-slate-800/50 rounded-lg overflow-hidden">
                <thead className="bg-slate-900/50">
                  <tr>
                    <th className="p-2 sm:p-3 md:p-4 text-left text-white font-semibold border-b border-slate-700 text-xs sm:text-sm md:text-base">Duration</th>
                    <th className="p-2 sm:p-3 md:p-4 text-left text-white font-semibold border-b border-slate-700 text-xs sm:text-sm md:text-base">Best For</th>
                    <th className="p-2 sm:p-3 md:p-4 text-left text-white font-semibold border-b border-slate-700 text-xs sm:text-sm md:text-base">Accuracy</th>
                    <th className="p-2 sm:p-3 md:p-4 text-left text-white font-semibold border-b border-slate-700 text-xs sm:text-sm md:text-base">Use Case</th>
                  </tr>
                </thead>
                <tbody className="text-slate-300">
                  <tr>
                    <td className="p-2 sm:p-3 md:p-4 border-b border-slate-700 text-xs sm:text-sm md:text-base">1 Minute</td>
                    <td className="p-2 sm:p-3 md:p-4 border-b border-slate-700 text-xs sm:text-sm md:text-base">Quick checks, warm-ups</td>
                    <td className="p-2 sm:p-3 md:p-4 border-b border-slate-700 text-xs sm:text-sm md:text-base">Moderate variance</td>
                    <td className="p-2 sm:p-3 md:p-4 border-b border-slate-700 text-xs sm:text-sm md:text-base">Daily practice, speed bursts</td>
                  </tr>
                  <tr className="bg-cyan-900/10">
                    <td className="p-2 sm:p-3 md:p-4 border-b border-slate-700 font-semibold text-cyan-400 text-xs sm:text-sm md:text-base">3 Minutes</td>
                    <td className="p-2 sm:p-3 md:p-4 border-b border-slate-700 text-xs sm:text-sm md:text-base">Accurate measurement</td>
                    <td className="p-2 sm:p-3 md:p-4 border-b border-slate-700 text-xs sm:text-sm md:text-base">Most consistent</td>
                    <td className="p-2 sm:p-3 md:p-4 border-b border-slate-700 text-xs sm:text-sm md:text-base">Job tests, certifications</td>
                  </tr>
                  <tr>
                    <td className="p-2 sm:p-3 md:p-4 text-xs sm:text-sm md:text-base">5 Minutes</td>
                    <td className="p-2 sm:p-3 md:p-4 text-xs sm:text-sm md:text-base">Endurance training</td>
                    <td className="p-2 sm:p-3 md:p-4 text-xs sm:text-sm md:text-base">Very stable</td>
                    <td className="p-2 sm:p-3 md:p-4 text-xs sm:text-sm md:text-base">Professional evaluation</td>
                  </tr>
                </tbody>
              </table>
            </div>

            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mt-6 sm:mt-8">Features of Our 3 Minute Typing Test</h3>
            <ul className="list-disc list-inside space-y-2 text-sm sm:text-base md:text-lg text-slate-300">
            ...
            <div className="bg-slate-800/50 border-l-4 border-cyan-500 p-4 sm:p-6 my-6 sm:my-8">
              <h4 className="text-base sm:text-lg md:text-xl font-bold text-cyan-400 mb-2">Expert Tip</h4>
            ...
            <h4 className="text-base sm:text-lg md:text-xl font-semibold text-cyan-400 mt-4 sm:mt-6">Is 3 minutes too long for a typing test?</h4>
            ...
            <h4 className="text-base sm:text-lg md:text-xl font-semibold text-cyan-400 mt-4 sm:mt-6">What's a good WPM for a 3-minute test?</h4>
            <p className="text-sm sm:text-base md:text-lg text-slate-300">
            ...
            <h4 className="text-base sm:text-lg md:text-xl font-semibold text-cyan-400 mt-4 sm:mt-6">Should I aim for speed or accuracy?</h4>
            <p className="text-sm sm:text-base md:text-lg text-slate-300">
        ...
        {/* Related Tests */}
        <section className="max-w-6xl mx-auto py-8 sm:py-12 md:py-16">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-center text-white mb-8 sm:mb-12">Try Other Test Durations</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            <Link href="/1-minute-typing-test">
              <Card className="bg-slate-800/50 border-slate-700 hover:border-cyan-500 transition-colors cursor-pointer" data-testid="card-1min-test">
                <CardHeader className="p-4 sm:p-6">
                  <CardTitle className="text-white text-base sm:text-lg">1 Minute Test</CardTitle>
            ...
            <Link href="/">
              <Card className="bg-slate-800/50 border-slate-700 hover:border-cyan-500 transition-colors cursor-pointer" data-testid="card-standard-test">
                <CardHeader className="p-4 sm:p-6">
                  <CardTitle className="text-white text-base sm:text-lg">Custom Duration</CardTitle>
                  <CardDescription className="text-slate-400 text-sm sm:text-base">
